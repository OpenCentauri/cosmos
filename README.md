...
## What does KOSMOS get me that the stock firmware or OC doesn't?
...
## How do I uninstall KOSMOS?
There is a button in the KOSMOS main menu that allows you to revert your printer to the stock firmware.

## Does installing KOSMOS break my printers warranty?
...
[Open an issue on GitHub](https://github.com/OpenCentauri/yocto-opencentauri/issues) and provide a brief description of what happened and the steps to reproduce it. Alternatively you can also drop by the #KOSMOS_development channel on the [Opencentauri Discord server](https://discord.gg/t6Cft3wNJ3) to let us know.

## Will KOSMOS be available for the Centauri Carbon 2?
Maybe, but developer efforts are focused on the CC1 for the time being

## Is KOSMOS related to the OpenCentauri board?
...
## How can I support KOSMOS development?
