...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/machine.cfg ${WORKDIR}/shell.cfg ${WORKDIR}/macros.cfg ${WORKDIR}/calibration.cfg ${WORKDIR}/screen.cfg ${WORKDIR}/client.cfg ${D}${sysconfdir}/klipper/config/klipper-readonly
